          ...
          <div className="grid grid-cols-2 gap-2">
            <p className="mb-2 leading-none space-y-0.5">
              ...
              <span className="flex items-center">
                <CardHeading2
                  title={data?.deviceCondition || <span>&nbsp;&nbsp;</span>}
                />
                <div className="ml-1">
                  <Image
                    src={InfoCircle}
            ...
            <p className="mb-2 leading-none space-y-0.5">
              ...
              <CardHeading2
                title={data?.listingDate || <span>&nbsp;&nbsp;</span>}
              />
            </p>
            ...
            <p className="mb-2 leading-none space-y-0.5">
              ...
              <CardHeading2
                title={data?.deviceStorage || <span>&nbsp;&nbsp;</span>}
              />
            </p>
            {data?.isVendor ? (
              <div className="grid">
          ...
          <div className="col-span-3 mt-2">
            ...
            <div className="flex justify-between items-end mt-2">
              {!listings.includes(data.listingId) ? (
                ...
                >
                  <a className="flex items-center w-full h-fx font-Roboto-Light text-ex px-5 py-2 bg-primary text-white rounded-[5px]">
                    <div className=" flex">
