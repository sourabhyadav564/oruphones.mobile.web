  ...
  return (
    <section className="container mb-6">
      <div className="content">
        <div id="why_xyz">
          <h1 className="text-[13px] font-Roboto-Bold">Why should I use ORUphones?</h1>
          <h2 className="font-Roboto-Medium text-[11px]">Buy & Sell Your Phone at ORUphones </h2>
          <p className="font-Roboto-Light text-[10px] text-left">
          ...
          <h2 className="font-Roboto-Medium text-[11px]">Why should you buy used phones on ORUphones? </h2>
          <p className="font-Roboto-Light text-[10px] text-left">
          ...
          <h2 className="font-Roboto-Medium text-[11px]"> Why should you sell your old mobile on ORUphones? </h2>
          <p className="font-Roboto-Light text-[10px] text-left">
        ...
        <div id="how_to_sell">
          <h2 className="font-Roboto-Medium text-[11px]">How to Sell Used Phone with ORUphones?</h2>
          <p className="font-Roboto-Light text-[10px] text-left">
        ...
        <div id="how_to_buy">
          <h2 className="font-Roboto-Medium text-[11px]">How to Buy ORUphones Verified Used Phones?</h2>
          <p className="font-Roboto-Light text-[10px] text-left">
        ...
        <div>
          <h2 className="font-Roboto-Medium text-[11px]">Popular Brands Listed on ORUphones</h2>
          <p className="font-Roboto-Light text-[10px] text-left">
