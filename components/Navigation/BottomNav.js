...
function BottomNav() {
  ...
  const logEvent = async () => {
    await logEventInfo("HOME_SELLNOW_SELECTED", Cookies.get("sessionId"));
  };
        ...
        >
          <div className="container flex justify-between items-end bg-primary-dark pb-3 pt-4 px-6 uppercase rounded-t-xl">
            <Link href="/" onClick={() => setLoadingState(true)}>
              <a
                ...
                className={`flex flex-col items-center   ${
                  isActive("/") ? "text-white font-Roboto-Semibold" : ""
                } `}
              >
                <Image
                  src={
                    "https://d1tl44nezj10jx.cloudfront.net/web/assets/bottom_icon/Path66.svg"
                  }
            ...
            <Link href="/user/listings" onClick={() => setLoadingState(true)}>
              <a
                className={`flex flex-col items-center ${
                  isActive("/user/listings")
                    ? "text-white font-Roboto-Semibold"
                    : ""
                } `}
              >
                <Image
                  src={
                    "https://d1tl44nezj10jx.cloudfront.net/web/assets/bottom_icon/to-do-list.svg"
                  }
                  width={isActive("/user/listings") ? 22 : 20}
                  height={isActive("/user/listings") ? 22 : 20}
                  alt="ORU mylistings"
                />
            ...
            >
              <div className="flex flex-col items-center" onClick={logEvent}>
                <a
                  ...
                  onClick={() => setLoadingState(true)}
                >
                  <div className="absolute bottom-0 p-4 rounded-full bg-[#f9c414] border-4 border-white hover:scale-125 duration-300">
                    <svg
                      width="24"
                      height="24"
                      fill="primary"
            ...
            <Link href="/services" onClick={() => setLoadingState(true)}>
              ...
              >
                ...
                <Image
                  src={
                    "https://d1tl44nezj10jx.cloudfront.net/web/assets/bottom_icon/Outline.svg"
                  }
                  width={isActive("/services") ? 22 : 20}
                  height={isActive("/services") ? 22 : 20}
                  alt="ORU services"
                />
            ...
            <Link href="/user/profile" onClick={() => setLoadingState(true)}>
              ...
              >
                <Image
                  src={
                    "https://d1tl44nezj10jx.cloudfront.net/web/assets/bottom_icon/user.svg"
                  }
                  width={isActive("/user/profile") ? 22 : 20}
                  height={isActive("/user/profile") ? 22 : 20}
                  alt="ORU user profile"
                />
