...
function BottomNav() {
  ...
  return (
    <div className="pt-24 bg-primary-dark">
      <div className="fixed z-50 bottom-0 bg-transparent w-full topShadow text-gray" style={{ fontSize: 10 }}>
        <div className="container flex justify-between items-end bg-white pb-3 pt-4 uppercase">
          <Link href="/">
            <a aria-current="page" className={`flex flex-col items-center   ${isActive("/") ? "text-primary" : ""} `}>
          ...
          <Link href="/user/listings">
            <a className={`flex flex-col items-center ${isActive("/user/listings") ? "text-primary" : ""} `}>
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 27 27">
                <path
                  id="tag"
          ...
          <Link href="/services">
            <a className={`flex flex-col items-center ${isActive("/services") ? "text-primary" : " "}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 31.5 28">
                <path
                  id="service-desk"
          ...
          <Link href="/user/profile">
            <a className={`flex flex-col items-center ${isActive("/user/profile") ? "text-primary" : " "}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 27 27">
