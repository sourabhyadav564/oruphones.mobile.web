...
function Header1() {
  ...
  return (
    <div className="flex justify-between items-center pt-0 py-2 px-2 text-sm font-medium bg-primary text-white sticky top-12 z-50 rounded-b-xl" data-aos="fade-down">
      <SearchBar />
    </div>
  );
}
