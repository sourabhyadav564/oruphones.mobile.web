export default function UnVerifiedIcon({ ...rest }) {
  return (
  <svg id="Group_28" data-name="Group 28" xmlns="http://www.w3.org/2000/svg" width="68.912" height="28.811" viewBox="0 0 68.912 28.811">
