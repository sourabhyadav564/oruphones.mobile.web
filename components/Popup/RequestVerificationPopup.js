  ...
  return (
    <Modal2 open={open} setOpen={setOpen}>
      <div className="flex flex-col items-center max-w-sm px-6 text-base text-black-4e">
        ...
        <h1 className="font-bold mt-1">Alert</h1>
        ...
        <div className="mb-2 mt-4 flex flex-col">
          <button className="border border-primary px-4 py-2 rounded text-primary uppercase w-full" onClick={() => sendVerificationLink()}>
            Request Verification
          </button>
          <button
            className="border border-primary w-full px-4 py-2 rounded text-primary mt-2"
            onClick={() => {
              setShowNumber(true);
              setOpen(false);
            }}
